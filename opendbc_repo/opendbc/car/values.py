...
from opendbc.car.lotte.values import CAR as LOTTE
...
Platform = BODY | CHRYSLER | FORD | GM | HONDA | HYUNDAI | LOTTE | MAZDA | MOCK | NISSAN | PSA | RIVIAN | SUBARU | TESLA | TOYOTA | VOLKSWAGEN
